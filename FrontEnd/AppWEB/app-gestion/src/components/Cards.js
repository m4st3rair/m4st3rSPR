    ...
    render(){
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-4">
                    <CardFunction
                        cardTitle="De nuevo Delta Software"
                        cardBody="Esto es otro texto de relleno mas a los que no estas acostumbrado"
                        cardImage="https://www.ucm.es/otri/file/20200211pangolin1"
                    >
                    </CardFunction>
